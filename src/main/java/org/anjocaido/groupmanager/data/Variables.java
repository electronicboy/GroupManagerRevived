...
/**
 * A class that holds variables of a user/group. In groups, it holds the
 * contents of INFO node. Like: prefix suffix build
 *
 * @author gabrielcouto
 */
public abstract class Variables implements Cloneable {
    ...
    /**
     * Add var to the the INFO node. examples: addVar("build",true);
     * addVar("prefix","c");
     *
