...
public class AnjoPermissionsHandler extends PermissionsReaderInterface {
    ...
    /**
     * Is there a direct or wildcard negation in the list which covers this
     * permission node.
     *
    ...
    /**
     * Wrapper for offline server checks. Looks for the
     * 'groupmanager.noofflineperms' permissions and reports no permissions on
     * servers set to offline.
     *
