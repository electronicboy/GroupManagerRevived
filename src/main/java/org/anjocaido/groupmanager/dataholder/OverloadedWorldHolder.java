...
public class OverloadedWorldHolder extends WorldDataHolder {
    ...
    /**
     * Gets the user in normal state. Surpassing the overload state. It doesn't
     * affect permissions. But it enables plugins change the actual user
     * permissions even in overload mode.
     *
     * @param userId
     * @return user object
     */
