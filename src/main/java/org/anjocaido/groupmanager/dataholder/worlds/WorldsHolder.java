...
public class WorldsHolder {
     ...
     * The key is the mirror. The object is the mirrored.
     *
    ...
    /**
     * Wrapper to retain backwards compatibility (call this function to auto
     * overwrite files)
     */
    ...
    /**
     * Returns the dataHolder for the given world. If the world is not on the
     * worlds list, returns the default world holder.
     *
     * Mirrors return their parent world data. If no mirroring data it returns
     * the default world.
     *
     * @param worldName
    ...
    /**
     * Id does getWorldDataByPlayerName(playerName). If it doesnt return null,
     * it will return result.getPermissionsHandler()
     *
     * @param playerName
     ...
     *
     * Load a world from file. If it already been loaded, summon reload method
     * from dataHolder.
     *
     * @param worldName
     */
